...
public class BlueJellyfishRenderer extends MobRenderer<AbstractJellyfishEntity, JellyfishModel<AbstractJellyfishEntity>> {
    ...
    public ResourceLocation getTextureLocation(AbstractJellyfishEntity pEntity) {
        return new ResourceLocation(Jellyfishing.MOD_ID, "textures/entity/blue_jellyfish.png");
    }
