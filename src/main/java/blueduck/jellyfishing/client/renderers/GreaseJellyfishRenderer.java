...
public class GreaseJellyfishRenderer extends MobRenderer<AbstractJellyfishEntity, GreaseJellyfishModel<AbstractJellyfishEntity>> {
    public GreaseJellyfishRenderer(EntityRendererProvider.Context context) {
        super(context, new GreaseJellyfishModel<>(context.bakeLayer(JellyfishModel.LAYER_LOCATION)), 0.3F);
    }

    @Override
    public ResourceLocation getTextureLocation(AbstractJellyfishEntity pEntity) {
        return new ResourceLocation(Jellyfishing.MOD_ID, "textures/entity/grease_jellyfish.png");
    }
