...
public class BlueJellyfishModel<T extends AbstractJellyfishEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Jellyfishing.MOD_ID, "blue_jellyfish"), "main");
	...
	public BlueJellyfishModel(ModelPart root) {
