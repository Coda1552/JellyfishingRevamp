...
public class SuitModel<T extends LivingEntity> extends HumanoidModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Jellyfishing.MOD_ID, "suit"), "main");
    public static final ResourceLocation TEXTURE_HELMET = new ResourceLocation(Jellyfishing.MOD_ID,"textures/models/armor/air_suit_helmet.png");
    public static final ResourceLocation TEXTURE_CHESTPLATE = new ResourceLocation(Jellyfishing.MOD_ID,"textures/models/armor/air_suit_chest.png");
    public static final ResourceLocation TEXTURE_LEGGINGS = new ResourceLocation(Jellyfishing.MOD_ID,"textures/models/armor/air_suit_legs.png");
    public static final ResourceLocation TEXTURE_BOOTS = new ResourceLocation(Jellyfishing.MOD_ID,"textures/models/armor/air_suit_boots.png");
