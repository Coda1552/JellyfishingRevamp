...
public class GreaseJellyfishModel<T extends AbstractJellyfishEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Jellyfishing.MOD_ID, "jellyfish"), "main");
	...
	public GreaseJellyfishModel(ModelPart root) {
